...
void rita02_(int& PDF, double& XLOW, double& XHIGH, int& N, int& NU, double& ERRM) { //OK
...
void ritai02_(int& PDF, double& XLOW, double& XHIGH, int& N, int& NU, double& ERRM) { //OK
...
//	g_imprimir<<<grid, block>>>(sizeTrack);
//	gpuErrchk(cudaDeviceSynchronize());
