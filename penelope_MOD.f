...
c   ****  Lower limit of the energy grid.
 ...
 2009   FORMAT(/1X,'Material data file: ')
...
C
	  ...
	  CALL transfcpin01(EI,CPS,BHA1,BHA2,BHA3,BHA4,MOM)
	  RETURN
...
C
	  ...
	  CALL transfCEBR01(EBT, XS, TXS, X, Y)
	  return
...
C
	...
	CALL transfCRELAX(IS0,IS1,IS2,IFIRST,ILAST,NCUR,KS,MODER,P,ET,F)
	RETURN
