...
static const int NSdiv = NS / 100;

typedef	struct {
	int NSURF[pilhaPart], KPLANE[NSdiv][pilhaPart];
	double AXX[NSdiv][pilhaPart],  AXY[NSdiv][pilhaPart],  AXZ[NSdiv][pilhaPart],  AYY[NSdiv][pilhaPart], AYZ[NSdiv][pilhaPart],
	       AZZ[NSdiv][pilhaPart],  AX[NSdiv][pilhaPart], AY[NSdiv][pilhaPart], AZ[NSdiv][pilhaPart], A0[NSdiv][pilhaPart];
} hd_QSURF;
